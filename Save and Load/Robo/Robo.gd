...
func _physics_process(delta):
	...
	globals.save_game["player_face"] = $sprite.scale.x
	globals.save_game["player_position"] = var2str(global_position)
...
func load_player():
	global_position = str2var(globals.save_game["player_position"])
	$sprite.scale.x = globals.save_game["player_face"]
